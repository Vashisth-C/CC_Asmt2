...
expression: unit| OPEN_PARANTHESIS expression CLOSE_PARANTHESIS | expression ARITHEMATIC_OP expression | expression BOOLEAN_OP expression | expression ARITHEMATIC_OP_MINUS expression
unit: IDENTIFIER|CONSTANT| IDENTIFIER OPEN_BRACKET expression CLOSE_BRACKET| BOOLEAN_OP_NOT unit| ARITHEMATIC_OP_MINUS unit 
